                    ...
                    <li>
                        <a href="#" class="js-sidebar-open">
                            <svg class="olymp-menu-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                                ...
                                <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-menu-icon') }}">
                                </use>
                            </svg>
                        </a>
                    </li>
                    <li>
                        <a href="03-Newsfeed.html">
                            <svg class="olymp-newsfeed-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                                ...
                                <use
                                    xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-newsfeed-icon') }}">
                                </use>
                            </svg>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="17-FriendGroups.html">
                            <svg class="olymp-happy-faces-icon left-menu-icon" data-toggle="tooltip"
                                ...
                                <use
                                    xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-happy-faces-icon') }}">
                                </use>
                            </svg>
                        </a>
                    </li>
                    <li>
                        <a href="18-MusicAndPlaylists.html">
                            <svg class="olymp-headphones-icon left-menu-icon" data-toggle="tooltip"
                                ...
                                <use
                                    xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-headphones-icon') }}">
                                </use>
                            </svg>
                        </a>
                    </li>
                    <li>
                        <a href="19-WeatherWidget.html">
                            <svg class="olymp-weather-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                                ...
                                <use
                                    xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-weather-icon') }}">
                                </use>
                            </svg>
                        </a>
                    </li>
                    <li>
                        <a href="20-CalendarAndEvents-MonthlyCalendar.html">
                            <svg class="olymp-calendar-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                                ...
                                <use
                                    xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-calendar-icon') }}">
                                </use>
                            </svg>
                        </a>
                    </li>
                    <li>
                        <a href="24-CommunityBadges.html">
                            <svg class="olymp-badge-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                                ...
                                <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-badge-icon') }}">
                                </use>
                            </svg>
                        </a>
                    </li>
                    <li>
                        <a href="25-FriendsBirthday.html">
                            <svg class="olymp-cupcake-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                                ...
                                <use
                                    xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-cupcake-icon') }}">
                                </use>
                            </svg>
                        </a>
                    </li>
                    <li>
                        <a href="26-Statistics.html">
                            <svg class="olymp-stats-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                                ...
                                <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-stats-icon') }}">
                                </use>
                            </svg>
                        </a>
                    </li>
                    <li>
                        <a href="27-ManageWidgets.html">
                            <svg class="olymp-manage-widgets-icon left-menu-icon" data-toggle="tooltip"
                                ...
                                <use
                                    xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-manage-widgets-icon') }}">
                                </use>
                            </svg>
                        </a>
                    </li>
    ...
    <div class="fixed-sidebar fixed-sidebar-responsive">
        ...
        <div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1-responsive">
            <a href="#" class="logo">
                ...
                <div class="title-block">
                    <h6 class="logo-title">Electrouni</h6>
                </div>
            </a>
                        ...
                        <a href="02-ProfilePage.html" class="author-name fn">
                            <div class="author-title">
                                James Spiegel <svg class="olymp-dropdown-arrow-icon">
                                    <use
                                        xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon') }}">
                                    </use>
                                </svg>
                            </div>
                    ...
                    <li>
                        <a href="#">
                            <svg class="olymp-logout-icon">
                                <use
                                    xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-logout-icon') }}">
                                </use>
                            </svg>
        ...
        <div class="fixed-sidebar-right sidebar--small" id="sidebar-right">
            ...
            <a href="#" class="olympus-chat inline-items js-chat-open">
                <svg class="olymp-chat---messages-icon">
                    <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-chat---messages-icon') }}">
                    </use>
                </svg>
            </a>
                            ...
                            <ul class="more-icons">
                                <li>
                                    <svg data-toggle="tooltip" data-placement="top"
                                        ...
                                        <use
                                            xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-comments-post-icon') }}">
                                        </use>
                                    </svg>
                                </li>
                                ...
                                <li>
                                    <svg data-toggle="tooltip" data-placement="top"
                                        ...
                                        <use
                                            xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-add-to-conversation-icon') }}">
                                        </use>
                                    </svg>
                                </li>
                                ...
                                <li>
                                    <svg data-toggle="tooltip" data-placement="top"
                                        ...
                                        <use
                                            xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-block-from-chat-icon') }}">
                                        </use>
                                    </svg>
                                </li>
                            </ul>
            ...
            <div class="search-friend inline-items">
                ...
                <a href="29-YourAccount-AccountSettings.html" class="settings">
                    <svg class="olymp-settings-icon">
                        <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-settings-icon') }}">
                        </use>
                    </svg>
                </a>
                ...
                <div class="form-group with-button">
                    ...
                    <button>
                        <svg class="olymp-magnifying-glass-icon">
                            <use
                                xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-magnifying-glass-icon') }}">
                            </use>
                        </svg>
                    </button>
                </div>
            ...
            <div class="control-block">
                ...
                <div class="control-icon more has-items">
                    <svg class="olymp-happy-face-icon">
                        <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-happy-face-icon') }}">
                        </use>
                    </svg>
                                ...
                                <li class="accepted">
                                    ...
                                    <div class="more">
                                        ...
                                        <svg class="olymp-little-delete">
                                            <use
                                                xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-little-delete') }}">
                                            </use>
                                        </svg>
                                    </div>
                                </li>
                ...
                <div class="control-icon more has-items">
                    <svg class="olymp-chat---messages-icon">
                        <use
                            xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-chat---messages-icon') }}">
                        </use>
                    </svg>
                ...
                <div class="control-icon more has-items">
                    <svg class="olymp-thunder-icon">
                        <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-thunder-icon') }}">
                        </use>
                    </svg>
                                ...
                                <li>
                                    ...
                                    <span class="notification-icon">
                                        <svg class="olymp-heart-icon">
                                            <use
                                                xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-heart-icon') }}">
                                            </use>
                                        </svg>
                                    </span>
                                ...
                                <ul class="account-settings">
                                    <li>
                                        <a href="29-YourAccount-AccountSettings.html">
                                            ...
                                            <svg class="olymp-menu-icon">
                                                <use
                                                    xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-menu-icon') }}">
                                                </use>
                                            </svg>
                                ...
                                <form class="form-group with-button custom-status">
                                    ...
                                    <button class="bg-purple">
                                        <svg class="olymp-check-icon">
                                            <use
                                                xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-check-icon') }}">
                                            </use>
                                        </svg>
                                    </button>
                                </form>
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#notification" role="tab">
                        <div class="control-icon has-items">
                            <svg class="olymp-thunder-icon">
                                <use
                                    xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-thunder-icon') }}">
                                </use>
                            </svg>
                            <div class="label-avatar bg-primary">8</div>
                        </div>
                        ...
                        <div class="top-header-thumb">
                            ...
                            <div class="control-block-button">
                                ...
                                <div class="btn btn-control bg-primary more">
                                    <svg class="olymp-settings-icon">
                                        <use
                                            xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-settings-icon') }}">
                                        </use>
                                    </svg>
                                ...
                                <div class="comments-shared">
                                    <a href="#" class="post-add-icon inline-items">
                                        <svg class="olymp-speech-balloon-icon">
                                            <use
                                                xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-speech-balloon-icon') }}">
                                            </use>
                                        </svg>
                                        <span>17</span>
                                    </a>
                                    ...
                                    <a href="#" class="post-add-icon inline-items">
                                        <svg class="olymp-share-icon">
                                            <use
                                                xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-share-icon') }}">
                                            </use>
                                        </svg>
                                        <span>24</span>
                                    </a>
                            ...
                            <div class="control-block-button post-control-button">
                                ...
                                <a href="#" class="btn btn-control">
                                    <svg class="olymp-like-post-icon">
                                        <use
                                            xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-like-post-icon') }}">
                                        </use>
                                    </svg>
                                </a>
                                ...
                                <div class="video-thumb">
                                    ...
                                    <a href="https://youtube.com/watch?v=excVFQ2TWig" class="play-video">
                                        <svg class="olymp-play-icon">
                                            <use
                                                xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-play-icon') }}">
                                            </use>
                                        </svg>
                                    </a>
                                </div>
