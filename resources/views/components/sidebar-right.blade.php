        ...
        <div class="modal-header">
            ...
            <div class="more">
                ...
                <svg class="olymp-little-delete js-chat-open">
                    <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-little-delete') }}">
                    </use>
                </svg>
            </div>
        </div>
        <div class="modal-body">
            <div class="mCustomScrollbar">
                <ul class="notification-list chat-message chat-message-field">
                    <li>
                        <div class="author-thumb">
                            <img src="{{ asset('assets/img/avatar14-sm.jpg') }}" alt="author"
                    ...
                    <div class="add-options-message">
                        ...
                        <div class="options-message smile-block">
                            ...
                            <svg class="olymp-happy-sticker-icon">
                                <use
                                    xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-happy-sticker-icon') }}">
                                </use>
                            </svg>
