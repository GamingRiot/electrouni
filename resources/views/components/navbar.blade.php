            ...
            <div class="author-page author vcard inline-items more">
                <div class="author-thumb">
                    @if (auth()->user()->about->profile_photo === null)
                        <img alt="author" src="{{ asset('assets/img/user.jpg') }}" class="avatar"
                            style="width:30px;">
                    @else
                        <img src="/{{ auth()->user()->about->profile_photo }}" alt="author" style="width:30px;">
                    @endif
                                ...
                                <li>
                                    <a href="36-FavPage-SettingsAndCreatePopup.html">
                                        <svg class="olymp-star-icon left-menu-icon" data-toggle="tooltip"
                                            ...
                                            <use
                                                xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-star-icon') }}">
                                            </use>
                                        </svg>
                ...
                <a href="/profile" class="author-name fn">
                    <div class="author-title">
                        {{ auth()->user()->user_name }} <svg class="olymp-dropdown-arrow-icon">
                            <use
