<div class="fixed-sidebar">
                ...
                <li>
                    <a href="03-Newsfeed.html">
                        <svg class="olymp-newsfeed-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-newsfeed-icon') }}">
                            </use>
                        </svg>
                    </a>
                </li>
                ...
                <li>
                    <a href="18-MusicAndPlaylists.html">
                        <svg class="olymp-headphones-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-headphones-icon') }}">
                            </use>
                        </svg>
                    </a>
                </li>
                <li>
                    <a href="19-WeatherWidget.html">
                        <svg class="olymp-weather-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-weather-icon') }}">
                            </use>
                        </svg>
                    </a>
                </li>
                <li>
                    <a href="20-CalendarAndEvents-MonthlyCalendar.html">
                        <svg class="olymp-calendar-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-calendar-icon') }}">
                            </use>
                        </svg>
                    </a>
                </li>
                ...
                <li>
                    <a href="25-FriendsBirthday.html">
                        <svg class="olymp-cupcake-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-cupcake-icon') }}">
                            </use>
                        </svg>
                    </a>
                </li>
    ...
    <div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
        <a href="02-ProfilePage.html" class="logo">
            <div class="img-wrap">
                <img src="{{ asset('assets/img/logo.png') }}" alt="Electrouni">
            </div>
                ...
                <li>
                    <a href="#">
                        <svg class="olymp-logout-icon">
                            <use xlink:href="{{ asset('assets/svg-icons/sprites/icons.svg#olymp-logout-icon') }}">
                            </use>
                        </svg>
